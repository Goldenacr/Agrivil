    ...
    <>
      ...
      <div className="bg-white">
        <section className="relative h-[400px] flex items-center justify-center overflow-hidden">
          ...
          <img class="absolute inset-0 w-full h-full object-cover" alt="Agricultural landscape" src="https://images.unsplash.com/photo-1610798264694-1c2d2af785c6" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <img class="w-full h-[400px] object-cover rounded-lg shadow-xl" alt="Golden Acres team" src="https://images.unsplash.com/photo-1637622124152-33adfabcc923" />
              </motion.div>
            </div>
          </div>
        </section>
